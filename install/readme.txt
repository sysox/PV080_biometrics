...
libftrScanAPI.so is the Linux version library.
We don't have a kernel mode driver for FS80 scanner, libftrScanAPI.so works with a well-known multiplatform library libusb, libusb is a library which allows userspace application access to USB devices. Last version of libusb is 0.1.12. This last version is recommended to install and work together with libftrScanAPI.so. The official site of this library - http://libusb.sourceforge.net.
